              ...
              <div className='w-6 h-6 rounded-full hover:bg-thbg group/more pb-[3px] pt-[4px] px-2.5 transition-all cursor-pointer relative'>
                ...
                <nav className='absolute top-4 left-3 w-64 rounded-lg shadow-lg bg-white hidden group-hover/more:block group-focus-within/more:block'>
                  <ul className=' list-none'>
                    <li className='even:bg-thlpurp py-1 px-2 hover:underline'><a href="/" className='flex items-center justify-start'><img src="/media/home/cards/bankPayment.png" alt="Payment"/><p className='ml-4'>Make payment</p></a></li>
                    <li className='even:bg-thlpurp py-1 px-2 hover:underline'><a href="/" className='flex items-center justify-start'><img src="/media/home/cards/bankBalance.png" alt="Balance"/><p className='ml-4'>View balance details</p></a></li>
                    <li className='even:bg-thlpurp py-1 px-2 hover:underline'><a href="/" className='flex items-center justify-start'><img src="/media/home/cards/bankAccount.png" alt="Account"/><p className='ml-4'>View account details</p></a></li>
                  </ul>
                </nav>
              </div>
          </div>
